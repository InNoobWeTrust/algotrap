...
use algotrap::ta::{LeapMonthPolicy, plum_blossom_signal_with_policy};
...
fn crypto_output_frame(
    ...
    let columns = vec![
        ...
        (
            ...
            numbers(|row| row.iching_original_energy),
        ),
        (
            "iching_transformed_energy".into(),
            numbers(|row| row.iching_transformed_energy),
        ),
        (
            "iching_nuclear_energy".into(),
            numbers(|row| row.iching_nuclear_energy),
        ),
    ...
    fn u4_1_projects_complete_ordered_pre_duckdb_schema_with_typed_columns() {
        ...
        let expected_columns = vec![
            ...
            (
                ...
                SourceColumnData::Number(vec![Some(11.5), Some(-31.5)]),
            ),
            (
