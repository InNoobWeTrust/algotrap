...
Each plan owns a directory containing its parent plan and all of its phases. Follow the parent document before entering a phase.
...
| Cryptobot RSSI Gap-Zone Trust Restoration | Planned | [`plan.md`](./plans/cryptobot-rssi-gap-trust-restoration/plan.md) · [`phases/`](./plans/cryptobot-rssi-gap-trust-restoration/phases/) |
